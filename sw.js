const CACHE='pindou-v13-direct-fill';
const SHELL=['./','./index.html','./styles.css','./app.js','./ocr-patch.js','./mard-colors.js','./recognition-v6.js','./recognition-v5.js','./recognition-v8.js','./recognition-v9.js?v=13','./recognition-v11.js?v=13','./manual-fill-v13.js?v=13','./manifest.webmanifest','./icon.svg'];
