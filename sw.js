const CACHE='pindou-v7';
const SHELL=['./','./index.html','./styles.css','./app.js','./ocr-patch.js','./mard-colors.js','./recognition-v6.js','./recognition-v5.js','./manifest.webmanifest','./icon.svg'];
