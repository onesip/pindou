const CACHE='pindou-v17-immersive';
const SHELL=['./','./index.html','./styles.css','./app.js','./app-v16.js?v=17','./app-v17-addon.js?v=17','./ocr-patch.js','./mard-colors.js','./recognition-v6.js','./recognition-v5.js','./recognition-v8.js','./recognition-v9.js?v=14','./manual-fill-v14.js?v=17','./manifest.webmanifest','./icon.svg'];
