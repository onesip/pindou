const CACHE='pindou-v12';
const SHELL=['./','./index.html','./styles.css','./app.js','./ocr-patch.js','./mard-colors.js','./recognition-v6.js','./recognition-v5.js','./recognition-v8.js','./recognition-v9.js','./recognition-v11.js','./smart-fill.js','./manifest.webmanifest','./icon.svg'];
