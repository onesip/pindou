const CACHE='pindou-v18-resume-fix';
const SHELL=['./','./index.html','./styles.css','./app.js','./app-v16.js?v=18','./app-v17-addon.js?v=18','./resume-fix-v18.js?v=18','./ocr-patch.js','./mard-colors.js','./recognition-v6.js','./recognition-v5.js','./recognition-v8.js','./recognition-v9.js?v=14','./manual-fill-v14.js?v=18','./manifest.webmanifest','./icon.svg'];
